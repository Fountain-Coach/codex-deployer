...
public struct Router {
    ...
    public func route(_ request: HTTPRequest) async throws -> HTTPResponse {
        ...
        case ("GET", let path) where path.hasPrefix("/planner/reflections/") && path.hasSuffix("/semantic-arc"):
        ...
        case ("GET", let path) where path.hasPrefix("/planner/reflections/"):
        ...
        case ("POST", "/planner/reflections"), ("POST", "/planner/reflections/"):

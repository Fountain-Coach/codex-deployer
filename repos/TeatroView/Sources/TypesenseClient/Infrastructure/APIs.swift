...
open class TypesenseClientAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "http://localhost:8108",
    ...
    public static let shared = TypesenseClientAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: TypesenseClientAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: TypesenseClientAPIConfiguration = TypesenseClientAPIConfiguration.shared) {
        self.method = method

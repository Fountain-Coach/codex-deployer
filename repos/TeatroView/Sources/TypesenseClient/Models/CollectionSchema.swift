...
public struct CollectionSchema: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, fields: [Field], defaultSortingField: String? = "", tokenSeparators: [String]? = nil, enableNestedFields: Bool? = false, symbolsToIndex: [String]? = nil, voiceQueryModel: VoiceQueryModelCollectionConfig? = nil) {
        self.name = name
        self.fields = fields
